...
//	}
	...
	public static void main(String[] args) throws Exception {
		// 公钥文件路径
/*		String publicKeyFilePath = "D:\\conf\\etcpUppPublic.key";
		// 私钥文件路径
		String privateKeyFilePath = "D:\\conf\\etcpUppPrivate.key";
		generateKeysAsFiles(publicKeyFilePath, privateKeyFilePath);
		
		Key[] keys = getKeysFromFiles(publicKeyFilePath, privateKeyFilePath);
		Key publicKey = keys[0];
		Key privateKey = keys[1];
//		String s = "1234567890qwertyuiop";
		String plainText = "{\"responseCode\":\"000000\",\"responseMsg\":\"交易成功\",\"partner\":\"UPP0000000120170203\",\"orderNo\":\"170203HD035495\",\"payToken\":\"34a79857-3d21-484b-90c4-f5c257b95da4\"}"; //明文

		String encryptStr = encrypt(plainText, publicKey, ENCRYPT_ALGORITHM_PKCS1);
		String decryptStr = decrypt(encryptStr, privateKey, ENCRYPT_ALGORITHM_PKCS1);
		System.out.println(encryptStr);
		System.out.println(decryptStr);
		
		String sign = sign(plainText, (PrivateKey)privateKey, SIGN_ALGORITHMS_MGF1, "utf-8");
		System.out.println(sign);
		
		boolean isSign = checkSign(plainText, sign, (PublicKey)publicKey,SIGN_ALGORITHMS_MGF1, "utf-8");
		System.out.println(isSign);
		
		
		String ed = ""*/;
		
//		PublicKey pukKey = getPublicKeyFromString("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCu6AiwARE48IGKEdac5zt75kaIRo4ERYm/tF4clpBn77pI6uVJXLnHzm6Vs3O87Qn+ZlYWaUaE/UM1kGsYedpkq6C5jJDGGrl3a/ifX+cPj9+M3nE+UCcrWMWHjerOuRWrrkcRLn08IzXcPhoQLfD29j/D0H321eL/jn7L5TWLOwIDAQAB");
//		PrivateKey priKey = getPrivateKeyFromString("");
//		String plainText = "Hellow Brother!你好，兄弟！";
//		String enStr = encrypt(plainText, pukKey, ENCRYPT_ALGORITHM_ECB_PKCS1);
		
/*		String enStr="mvDkOepUD36SdaNtvejN4HdEd0rz3OwiurXHYny4B9OkmXIHqXSWZ74SgdR09ipGlly4klh9l/xqqey5dm3uM1j2d25+o4D1MN4RPScI2sZrKKaTeM8zyTElaare5pJ6r5jQq5xos1Eqph/8eR5AhU1ZBoQhQHKzjMHONy0TtPw=";
		
		String sign = sign(plainText, priKey, SIGN_ALGORITHMS_MGF1, UTF_8);
		
		System.out.println(enStr);
		
		System.out.println(decrypt(enStr, priKey, ENCRYPT_ALGORITHM_PKCS1));//ENCRYPT_ALGORITHM_PKCS1
		
		System.out.println("-------------");
		System.out.println(sign);*/
		
/*		String publicKeyFilePath = "D:\\conf\\uppPublic.key";
		// 私钥文件路径
		...
		System.out.println(authReqSign);
	}
}
