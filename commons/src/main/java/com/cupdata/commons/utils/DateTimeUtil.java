...
//    	String[] parsePatterns = {"yyyyMMddHHmmssSSS"};
//		try {
//			Date date = DateUtils.parseDate("20161340112230234", parsePatterns);
//			System.out.println();
//		} catch (ParseException e) {
//			e.printStackTrace();
//			
...
//    	Date nd = beginOfNextDay(new Date());
//    	System.out.println(getFormatDate(nd, "yyyyMMdd HH:mm:ss:SSS"));
    	
//    	System.out.println(getFormatDate(new Date(), "yyyyMMdd"));
//    	System.out.println(getFormatDate(new Date(), "HHmmss"));
//    	2017-02-13 09:02:47
//    	2017-02-13 09:02:48662
    	
//    	Date date = new Date();//1486947767000
//    	
//    	System.out.println(getFormatDate(date, "EEEE dd yyyy MM dd HH mm ss SSS"));
//    	
    	
//    	String timeStr = "20170428";
//    	String pattern = "yyyyMMdd";
//    	String pattern1 = "E";
//    	Date d = parseDate(timeStr, pattern);
//    	String ds = getFormatDate(d, pattern1);
...
//    	String ss = "14:20";
//    	String ee = "18:20";
//    	Date cycleStart = DateTimeUtil.getDateByString(ss, "HH:mm");
//		Date cycleEnd = DateTimeUtil.getDateByString(ee, "HH:mm");
//		System.out.println(ss.compareTo(ee));
//		
//		
//		System.out.println(cycleStart.toString());
//		System.out.println(cycleEnd.toString());
    	
    	
//    	Calendar cal = Calendar.getInstance();
//    	cal.setTime(getDateByString("20170423", "yyyyMMdd"));
//    	String s = String.valueOf(((cal.get(Calendar.DAY_OF_WEEK) + 6) % 7 == 0 ? 7:(cal.get(Calendar.DAY_OF_WEEK) + 6) % 7));
//    	System.out.println(s);
    	
//    	String ss = "20170512";
//    	Date cc = getDateByString(ss, "yyyyMMdd");
//    	Date[] sAndE = getDaysOfWeek(cc);
